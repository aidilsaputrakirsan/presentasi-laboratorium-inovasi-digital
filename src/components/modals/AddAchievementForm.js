  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
      <div className="sticky top-0 bg-white border-b p-6 flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900">Dokumentasi Prestasi Baru</h2>
      ...
      <div className="p-6">
        <form className="space-y-6">
          ...
          <div>
            ...
            <textarea rows="4" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-pink-500" placeholder="Deskripsi lengkap tentang prestasi yang diraih..."></textarea>
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Dampak/Impact</label>
            <textarea rows="3" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-pink-500" placeholder="Jelaskan dampak atau impact dari prestasi ini..."></textarea>
          </div>
